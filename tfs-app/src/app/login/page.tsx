    ...
    >
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 md:p-10">
        <div className="flex justify-center mb-8">
          <Image src="/images/logo.png" alt="Tenant Financial Solutions" width={180} height={54} className="h-12 w-auto" />
        </div>

        <h1 className="text-2xl font-serif font-bold text-tfs-navy text-center mb-1">Welcome back</h1>
        <p className="text-tfs-slate text-sm text-center mb-8">Sign in to your account</p>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border-2 border-gray-200
                     rounded-lg px-4 py-2.5 text-sm font-medium text-tfs-navy hover:border-tfs-teal
                     hover:bg-tfs-teal-light transition-colors"
        >
