    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Cross-Origin-Opener-Policy', value: 'same-origin-allow-popups' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://va.vercel-scripts.com https://www.weblaunchacademy.com https://weblaunchacademy.com https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://unpkg.com",
