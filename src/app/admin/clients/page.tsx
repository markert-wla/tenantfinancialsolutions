...
export default async function AdminClientsPage() {
  ...
  const [{ data: clients }, { data: pmCodes }] = await Promise.all([
    supabase
      .from('profiles')
      .select('id, first_name, last_name, email, plan_tier, client_type, promo_code_used, free_trial_expires_at, sessions_used_this_month, extra_sessions, last_active_at, is_active, created_at, stripe_customer_id')
      .eq('role', 'client')
